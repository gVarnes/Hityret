...
if (sliders) {
	for (let index = 0; index < sliders.length; index++) {
		...
		if (!slider.classList.contains('swiper-bild')) {
			...
			slider_wrapper.classList.add('swiper-wrapper_new');
...
let slider_main = new Swiper('.main-menu__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.controls-arrow .controls-arrow_next',
		prevEl: '.controls-arrow .controls-arrow_prev',
	},
...
let newsContainer = document.querySelector('.news__slider');
let documentElem = document.documentElement;
let windowWidth = documentElem.clientWidth;
let slider_news;
...
const breakpointChecker = function () {
	...
	if (breakpoint.matches === true) {
		...
		if (slider_news !== undefined) slider_news.destroy(true, true);
...
const enableSwiper = function () {
	...
	slider_news = new Swiper('.news__slider', {
		...
		// Arrows
		navigation: {
			nextEl: '.new-controls-arrow .new-controls-arrow_next',
			prevEl: '.new-controls-arrow .new-controls-arrow_prev',
		},
...
if (iconMenu != null) {
	...
	let labelMenu = document.querySelector(".header__label");
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
			body_lock(delay);
			iconMenu.classList.toggle("_active");
			menuBody.classList.toggle("_active");
			labelMenu.classList.toggle("_active");
		}
	});
};
function menu_close() {
	...
	labelMenu.classList.remove("_active");
}
//=================
//BodyLock
